...
# Atividade realizada em 20/05/2022

# Configurando o diretório de trabalho
# setwd("C:/Users/deeww/OneDrive/Ãrea de Trabalho/Ciencia de dados/Curso FormaÃ§Ã£o Cientista de dados/BigData_R_Azure_ML/cap04")
# getwd()
...
########## Server - Lógica do Servidor ########## Onde cria-se os gráficos
